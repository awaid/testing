...
+ (WSAssetsTableViewCell *)assetsCellWithAssets:(NSArray *)assets reuseIdentifier:(NSString *)identifier
{
    ...
    cell.cellAssetViews = [[NSMutableArray alloc] initWithArray:assets];
...
- (id)initWithAssets:(NSArray *)assets reuseIdentifier:(NSString *)identifier
{
    if ((self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier])) {
        ...
        self.cellAssetViews =[[NSMutableArray alloc] initWithArray:assets];
    }
...
- (void)setCellAssetViews:(NSArray *)assets
{
    ...
    NSMutableArray *columns = [[NSMutableArray alloc] initWithCapacity:[assets count]];
    
    for (WSAssetWrapper *assetWrapper in assets) {
        
        WSAssetViewColumn *assetViewColumn = [[WSAssetViewColumn alloc] init];// initWithImage:[UIImage imageWithCGImage:assetWrapper.asset.thumbnail]];
