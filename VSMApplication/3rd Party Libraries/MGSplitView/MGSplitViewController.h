...
@property (nonatomic,retain) VSPopoverViewController *popoverViewController;
// Actions
...
- (IBAction)showPopover:(id)sender;// shows the master view in a popover spawned from the provided barButtonItem, if it's currently hidden.
